...
face_cascade1 = cv2.CascadeClassifier('cascades/lbpcascade_frontalface.xml')
...
while(True):
    try:
        ...
        faces1 = face_cascade1.detectMultiScale(frame1, 1.3, 5)
        #print(len(faces))
        ...
        for (x,y,w,h) in faces1:
          ...
          #  if w>50 and h>50 and a ==1 and end - start > 1:
                ...
                #cv2.imwrite('faces/f_'+str(len(faces))+'_'+strftime('%d%m%y_%H%M%S',gmtime())+'.jpg',crop_img ) 
